...
<div class="product-details"><!--product-details-->
						...
						<div class="col-sm-7">
							<div class="product-information"><!--/product-information-->
								...
								<p><b>Kho còn:</b>&ensp;{{$value->product_quantity}} sản phẩm</p>
								<p><b>Điều kiện:</b> Mơi 100%</p>
								<p><b>Thương hiệu:</b>&ensp;{{$value->brand_name}}</p>
								<p><b>Danh mục:</b>&ensp;{{$value->category_name}}</p>
					...
					<div class="category-tab shop-details-tab"><!--category-tab-->
						<div class="col-sm-12">
							<ul class="nav nav-tabs nav-deltail-product">
