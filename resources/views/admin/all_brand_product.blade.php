      ...
      <table class="table table-striped b-t b-light">
        ...
        <tbody>
          ...
          <tr>
            ...
            <td><img src="public/uploads/product/{{$brand_pro->brand_image}}" height="100" width="100" alt=""></td>
            <td>{{ $brand_pro->brand_slug }}</td>
            <td><span class="text-ellipsis">
              <?php
               if($brand_pro->brand_status==0){
                ?>
                <a href="{{URL::to('/unactive-brand-product/'.$brand_pro->brand_id)}}"><span>Ẩn</span></a>
                <?php
                 }else{
                ?>  
                 <a href="{{URL::to('/active-brand-product/'.$brand_pro->brand_id)}}"><span>Hiển thị</span></a>
                <?php
               }
              ?>
            </span></td>
