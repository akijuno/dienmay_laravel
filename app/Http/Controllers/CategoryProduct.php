...
class CategoryProduct extends Controller
{
    ...
    public function save_category_product(Request $request){
        ...
        Session::put("message","<script> alert('Thêm danh mục sản phẩm thành công')</script>");
    	return Redirect::to('all-category-product');
    }
    public function unactive_category_product($category_product_id){
        $this->AuthLogin();
        DB::table('tbl_category_product')->where('category_id',$category_product_id)->update(['category_status'=>1]);
        Session::put("message","<script> alert('Hiển thị danh mục sản phẩm')</script>");
        return Redirect::to('all-category-product');
    ...
    public function active_category_product($category_product_id){
        ...
        Session::put("message","<script> alert('ẩn danh mục sản phẩm')</script>");
        return Redirect::to('all-category-product');
    }
    ...
    public function update_category_product(Request $request,$category_product_id){
        ...
        Session::put("message","<script> alert('Cập nhật danh mục sản phẩm thành công')</script>");
        return Redirect::to('all-category-product');
    }
